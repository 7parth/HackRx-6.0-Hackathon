...
class DirectAnswerEngine:
    ...
    def __init__(self, llm, max_answer_tokens: int = 512):
        ...
        self.answer_prompt = PromptTemplate.from_template(
            """Based on the provided context, answer the question directly and concisely.

Context: {clauses}

Question: {query}

Answer (be specific and use only the context):"""
        )
...
class AdaptiveGeneralLLMDocumentQASystem:
    ...
    def load_documents_from_content_adaptive(self, documents: List[Dict[str, Any]]) -> Dict:
        """Load documents with performance-optimized adaptive parameter selection"""
        ...
        batch_size = min(50, len(chunks))  # Process in smaller batches
        ...
        # Save index asynchronously for better performance
